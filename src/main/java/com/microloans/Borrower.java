		...
		try {
			...
			if (!connection.isClosed()) 
				...
				try {
				      ...
				      JSONObject borrowers = new JSONObject();
				     ...
				     // pstmt.setInt(1, 1001); // set input parameter
				      ...
				      borrowers.put("borrowers",jArray);
				      
				      out.print(borrowers.toString());
...
//				String lender = "SELECT * FROM Borrower ;";
...
//		}
	...
	//        String lastupdate = null;
	        ...
	        String sqlBorrower = null;
			if (action != null  && action.equals("edit")  ) {
				 sqlBorrower = "UPDATE Borrower SET Name='"+name+"',Town='"+town+
				"',StreetName='"+streetname+"',StreetNumber='"+streetnumber+
				"', VAT='"+vat+"', PostalCode='"+postalcode+"' WHERE idBorrower="+id+";";
			
	
					
			}else if(action != null  && action.equals("create")  ){
				sqlBorrower = "INSERT INTO Borrower (Name,Town,StreetName,StreetNumber,VAT,PostalCode) VALUES('"+name+"','"+town+
				"','"+streetname+"','"+streetnumber+
				"', '"+vat+"','"+postalcode+"') ;";

			}
			
			PreparedStatement ps=connection.prepareStatement(sqlBorrower);
			ps.executeUpdate();
...
//	        json.put("lastupdate", lastupdate);
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String deleteBorrower = "DELETE FROM Borrower WHERE idBorrower="+stringId+";";
			PreparedStatement ps=connection.prepareStatement(deleteBorrower);
			ps.executeUpdate();
			out.print("{}");
